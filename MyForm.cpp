...
System::Void KURSA4::MyForm::справкаToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	MyForm_help^ form_help = gcnew MyForm_help();
	form_help->ShowDialog();
	return System::Void();
}

System::Void KURSA4::MyForm::загрузитьToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	this->button_download_Click(sender, e);
	return System::Void();
}

System::Void KURSA4::MyForm::сохранитьToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	this->button_download_Click(sender, e);
	return System::Void();
}

System::Void KURSA4::MyForm::выходToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
	Application::Exit();
	return System::Void();
}
